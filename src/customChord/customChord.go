...
func startUpSystem(nodeAddr string) {
  ...
  for {
    ...
    switch msg.Cmd {
      ...
      case "_getInfo":
        fmt.Println("Received get info for type: ", msg.Type)
      ...
      case "_resInfo":
        ...
        if msg.Type == "ftab" {
          ...
          // TODO: Transfer file segment to this node
        } else {
...
func TransferFileSegment(filename string) {
...
//           streamServerChannel <- msg.Val
//         } else {
//           fmt.Println("I ain't got no type. Bad bitches is the only thing that I like")
//         }
//       case "_setVal":
//         _, haveKey := getVal(msg.Key)
//         if haveKey {
